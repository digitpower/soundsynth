#ifndef AUDIOFILE_READER
#define AUDIOFILE_READER
...
class AudioFileReader : public Ugen{
public:
    AudioFileReader();
...
public:
    void loadFiles(char **audioFiles, int fileCount);
private:
    void pullDataAndPlay_audiofilereader(void *outputBuffer, unsigned long framesPerBuffer);
private:
    pthread_t m_audioFileReaderThread;
    enum StreamState audiofile_reader_stream_state;
